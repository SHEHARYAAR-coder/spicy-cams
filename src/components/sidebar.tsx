...
export function Sidebar({ streams = [], selectedCategory = "Home", onCategoryChange }: SidebarProps) {
    ...
    return (
        <div className="hidden lg:block sticky top-32 left-0 h-[calc(100vh-8rem)] w-72 bg-gradient-to-b from-gray-900 via-gray-900/98 to-gray-950 backdrop-blur-md border-r border-gray-800/80 overflow-y-auto scrollbar-hide z-40 shadow-2xl">
