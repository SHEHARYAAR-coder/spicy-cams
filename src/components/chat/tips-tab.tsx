...
import { Heart, Gift, Gamepad2, Zap } from "lucide-react";
...
export function TipsTab({ onTip, className }: TipsTabProps) {
    ...
    return (
        <div className={`flex flex-col h-full bg-gray-900 ${className || ''}`}>
            ...
            <div className="flex-1 overflow-hidden">
                ...
                {activeSubTab === "toy" && (
                    <div className="h-full px-3 sm:px-4 py-4 flex items-center justify-center">
